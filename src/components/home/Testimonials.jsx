                ...
                <div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10">
                    ...
                    <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
                        ...
                        <div className="flex flex-col items-center justify-center p-8 rounded-b-lg dark:bg-violet-400 dark:text-gray-900">
                            <img src={`https://img.freepik.com/free-photo/young-beautiful-woman-pink-warm-sweater-natural-look-smiling-portrait-isolated-long-hair_285396-896.jpg?t=st=1734628459~exp=1734632059~hmac=d3284dca87688000fa021414adb7b520955a33f3ac559b0f35c5f6e8b9abe606&w=900`} alt="" className="w-16 h-16 mb-2 -mt-16 bg-center bg-cover rounded-full bg-gray-500 " />
